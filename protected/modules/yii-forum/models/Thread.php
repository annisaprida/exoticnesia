...
class Thread extends CActiveRecord
{
    ...
    public function rules() {
        ...
        return array(
            ...
            array('first_post','numerical', 'integerOnly'=>true),
            /**
    ...
    public function renderSubjectCell()
    {
        ...
        $author= $firstpost->authorUsername;

        $subjlink = CHtml::link(CHtml::encode($this->subject), $this->url);
        $authorlink = CHtml::link(CHtml::encode($author), array('/pengguna/view', 'id'=>$author));
        // array('/pengguna/view','id'=>$data->username0->username)
    ...
    public function renderLastpostCell()
    {
        ...
        $author = $lastpost->authorUsername;

        $authorlink = CHtml::link(CHtml::encode($lastpost->authorUsername), array('/pengguna/view', 'id'=>$lastpost->authorUsername));
